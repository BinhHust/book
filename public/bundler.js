...
var showAlert = function showAlert(message, type) {
  hideAlert();
  var markup = "\n    <div class=\"alert alert-".concat(type === 'success' ? 'success' : 'danger', "\" role=\"alert\" style=\"position: fixed; top: 0; left: 50%; transform: translateX(-50%); z-index: 10\">\n      ").concat(message, "\n    </div>\n  ");
  document.body.insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert = showAlert;
},{}],"verifyToken.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/users/verifyToken/".concat(token)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('Verify token successfully.', 'success');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alert.showAlert)('Login in successfull.', 'success');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)(_context2.t0.response.data.message, 'error');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)("".concat(type.toUpperCase(), " updated successfully!"), 'success');
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)(res.data.message, 'success');
              setTimeout(function () {
...
var $verifyEmail = document.querySelector('.verify-email');
var $signupForm = document.getElementById('signup-form');
var $signupContainer = document.getElementById('signup-container');
var $loginForm = document.getElementById('login-form');
var $logoutBtn = document.getElementById('logout');
var $updateDataForm = document.getElementById('update-data-form');
...
if ($verifyEmail) {
  $verifyEmail.addEventListener('click', function () {
    ...
    (0, _verifyToken.verifyToken)(token);
  });
}
...
if ($booksContainer) {
  $booksContainer.addEventListener('click', function (e) {
    var $addToCartBtn = e.target.closest('#addToCart');
