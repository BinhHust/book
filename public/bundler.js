...
var showAlert = function showAlert(message, type) {
  hideAlert();
  var markup = "\n    <div class=\"alert alert-".concat(type === 'success' ? 'success' : 'danger', "\" role=\"alert\">\n      ").concat(message, "\n    </div>\n  ");
